...
public class UserService {
    ...
    public boolean updateUserProfile(String emailOrUsername, Map<String, Object> profileData) {
        try {
            ...
            Integer userCount = jdbcTemplate.queryForObject(checkQuery, Integer.class, emailOrUsername,
                    emailOrUsername);
    ...
    public boolean changePassword(String username, String currentPassword, String newPassword) {
        try {
            ...
            Integer count = jdbcTemplate.queryForObject(verifyQuery, Integer.class, username, username,
                    currentPassword);
